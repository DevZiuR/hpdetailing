        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="lg:col-span-1 reveal-on-scroll opacity-0 translate-y-6 will-change-transform">
            ...
            <p className="text-muted-foreground mb-6 leading-relaxed">
              Professional mobile automotive detailing services in Miami. 
              We bring showroom quality results directly to your location.
            </p>
            ...
            <div className="mt-6">
              <div className="flex space-x-2">
                <Button
                  ...
                  onClick={() => handleContactClick("sms:+13059724252")}
                >
        ...
        <div className="border-t border-border/50 pt-8 reveal-on-scroll opacity-0 translate-y-6 will-change-transform">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-muted-foreground text-sm">
              © 2025 High Performance Detail. All rights reserved.
            </div>
